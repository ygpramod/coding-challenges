...
class QuickSortTest {
    ...
    void test0() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{1});
    ...
    void test1() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{2, 1});
    ...
    void test2() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{3, 1});
    ...
    void test3() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{3, 1, 2});
    ...
    void test4() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{3, 2, 1});
        assertThat(testSubject).isEqualTo(new int[]{1, 2, 3});
    }
    ...
    void test5() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{1, 3, 2});
        assertThat(testSubject).isEqualTo(new int[]{1, 2, 3});
    }
    ...
    void test6() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{1, 2, 2});
    ...
    void test7() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{1, 2, 2, 3});
    ...
    void test8() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{2, 2, 2, 3});
    ...
    void test9() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{2, 2, 2, 2});
    ...
    void test10() {
        ...
        int[] testSubject = new QuickSort().sort(new int[]{1, 1, 4, 6, 8, 5, 15, 7, 25, 2, 15});
